...
y_axis_view_class_init (YAxisViewClass *klass)
{
  ...
  g_object_class_install_property (object_class, AXIS_VIEW_DRAW_EDGE, 
                    g_param_spec_boolean ("draw_edge", "Draw Edge", "Whether to draw the axis edge",
  ...
  g_object_class_install_property (object_class, AXIS_VIEW_EDGE_THICKNESS, 
                    g_param_spec_double ("edge_thickness", "Edge Thickness", "The thickness of the axis edge in points",
  ...
  g_object_class_install_property (object_class, AXIS_VIEW_DRAW_LABEL, 
                    g_param_spec_boolean ("draw_label", "Draw Label", "Whether to draw an axis label",
  ...
  g_object_class_install_property (object_class, AXIS_VIEW_LABEL_OFFSET, 
                    g_param_spec_double ("label_offset", "Label Offset", "The gap between ticks and labels in points",
                                        0, 10, 72.0/64.0 , G_PARAM_READWRITE | G_PARAM_CONSTRUCT));
                                        
  g_object_class_install_property (object_class, AXIS_VIEW_AXIS_LABEL, 
                    g_param_spec_string ("axis_label", "Axis Label", "Set axis label", "", G_PARAM_READWRITE | G_PARAM_CONSTRUCT));
                                        
  g_object_class_install_property (object_class, AXIS_VIEW_SHOW_MAJOR_TICKS, 
                    g_param_spec_boolean ("show_major_ticks", "Show major ticks", "Whether to draw major ticks",
  ...
  g_object_class_install_property (object_class, AXIS_VIEW_MAJOR_TICK_THICKNESS, 
                    g_param_spec_double ("major_tick_thickness", "Major Tick Thickness", "The thickness of major ticks in points",
                                        0, 10, DEFAULT_LINE_THICKNESS , G_PARAM_READWRITE | G_PARAM_CONSTRUCT));
                                        
  g_object_class_install_property (object_class, AXIS_VIEW_MAJOR_TICK_LENGTH, 
                    g_param_spec_double ("major_tick_length", "Major Tick Length", "The length of major ticks in points",
                                        0, 10, 3.0 , G_PARAM_READWRITE | G_PARAM_CONSTRUCT));
                                        
  g_object_class_install_property (object_class, AXIS_VIEW_SHOW_MINOR_TICKS, 
                    g_param_spec_boolean ("show_minor_ticks", "Show minor ticks", "Whether to draw minor ticks",
  ...
  g_object_class_install_property (object_class, AXIS_VIEW_SHOW_MAJOR_LABELS, 
                    g_param_spec_boolean ("show_major_labels", "Show major labels", "Whether to draw major labels",
