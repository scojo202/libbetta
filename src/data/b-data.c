 ...
 **/
void
y_data_emit_changed (YData * data)
{
 ...
 **/
gint64
y_data_get_timestamp (YData * data)
{
  YDataPrivate *priv = y_data_get_instance_private (data);
...
static char
_scalar_get_sizes (YData * data, unsigned int *sizes)
{
  return 0;
}
...
static double
y_val_scalar_get_value (YScalar * dat)
{
...
static void
y_val_scalar_class_init (YValScalarClass * scalarval_klass)
{
...
static void
y_val_scalar_init (YValScalar * val)
{
}
 ...
 **/
double *
y_val_scalar_get_val (YValScalar * s)
{
...
G_DEFINE_ABSTRACT_TYPE_WITH_PRIVATE (YThreeDArray, y_three_d_array,
				     Y_TYPE_DATA);
...
static gboolean
_three_d_array_has_value (YData * dat)
{
 ...
 **/
char *
y_three_d_array_get_str (YThreeDArray * mat, unsigned i, unsigned j,
